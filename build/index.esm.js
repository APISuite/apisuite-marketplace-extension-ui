import { forwardRef, createElement, Fragment, useState, useEffect } from 'react';
import i18next from 'i18next';
import { useTranslation } from 'react-i18next';
import { bindActionCreators } from 'redux';
import { connect } from 'react-redux';
import { Link as Link$1 } from 'react-router-dom';
import { Avatar, FormControlLabel, Checkbox, TextField, InputAdornment, FormControl, FormLabel, RadioGroup, Radio, Accordion, AccordionSummary, Typography, AccordionDetails, FormGroup } from '@material-ui/core';
    ...
    var generateAppCatalogEntry = function (appDetails, index) {
        ...
        return (createElement("div", { className: classes.appCatalogEntry, key: "appCatalogEntry" + index },
            ...
            createElement("div", { className: classes.appCatalogEntryBottomDetails },
                ...
                createElement("p", { className: classes.appCatalogEntryLabel }, appDetails.appLabel))));
    };
    var appCatalogEntries = appsToDisplay.map(function (appDetails, index) {
        return (createElement(Link, { className: classes.appCatalogEntryLink, key: "linkToApp" + index, to: "#" }, generateAppCatalogEntry(appDetails, index)));
    });
    return createElement(Fragment, null, appCatalogEntries);
};
...
var Marketplace$1 = function (_a) {
    ...
    // Label filters
    var _d = useState({}), labelFilters = _d[0], setLabelFilters = _d[1];
    var _e = useState([]), labelFilterElements = _e[0], setLabelFilterElements = _e[1];
    useEffect(function () {
        var newLabelFilters = {};
        ...
        var newLabelFilterElements = allMarketplaceLabels.map(function (label, index) {
            return (createElement(FormControlLabel, { className: newLabelFilters[label]
                    ? classes.selectedFilter
                    : classes.notSelectedFilter, control: createElement(Checkbox, { checked: newLabelFilters[label], name: label, onChange: function (clickEvent) { return filterSelection(clickEvent, 'labels'); } }), key: "labelFilterElement" + index, label: label }));
        });
        setLabelFilters(newLabelFilters);
        setLabelFilterElements(newLabelFilterElements);
    }, [allMarketplaceLabels]);
    // Publisher filters
    var _f = useState({}), publisherFilters = _f[0], setPublisherFilters = _f[1];
    var _g = useState([]), publisherFilterElements = _g[0], setPublisherFilterElements = _g[1];
    useEffect(function () {
        ...
        var newPublisherFilterElements = publisherNames.map(function (publisherName, index) {
            ...
            return (createElement(FormControlLabel, { className: newPublisherFilters[publisherName]
                    ? classes.selectedFilter
                    : classes.notSelectedFilter, control: createElement(Checkbox, { checked: newPublisherFilters[publisherName], name: publisherName, onChange: function (clickEvent) {
    ...
    // App sorting mode
    var _h = useState('appName'), sortMode = _h[0], setSortMode = _h[1]; // Either 'appName', 'publisherName', or 'lastUpdated'
    ...
    var _j = useState([]), filteredAppsList = _j[0], setFilteredAppsList = _j[1];
    useEffect(function () {
    ...
    var _k = useState(0), currentSlide = _k[0]; _k[1];
                ...
                createElement(FormControl, null,
                    createElement(FormLabel, null,
                        createElement("div", { className: classes.filterTitleContainer },
                            ...
                            createElement("p", { className: classes.filterTitleText }, "Sort by:"))),
                    createElement(RadioGroup, { name: "sortMode", onChange: sortModeSelection, value: sortMode },
                        createElement(FormControlLabel, { className: sortMode === 'appName'
                                ? classes.selectedFilter
                                : classes.notSelectedFilter, control: createElement(Radio, null), label: "Application name", value: "appName" }),
                        createElement(FormControlLabel, { className: sortMode === 'publisherName'
                                ? classes.selectedFilter
                                : classes.notSelectedFilter, control: createElement(Radio, null), label: "Publisher name", value: "publisherName" }),
                        createElement(FormControlLabel, { className: sortMode === 'lastUpdated'
                                ? classes.selectedFilter
                                : classes.notSelectedFilter, control: createElement(Radio, null), label: "Last updated", value: "lastUpdated" }))),
                createElement("hr", { className: classes.filterSeparator }),
                createElement(FormControl, null,
                    createElement(FormLabel, null,
                        createElement("div", { className: classes.filterTitleContainer },
                            createElement(FilterListRoundedIcon, { className: classes.filterTitleIcon }),
                            createElement("p", { className: classes.filterTitleText }, "Filter by:"))),
                    createElement(Accordion, { className: classes.filterAccordionContainer },
                        createElement(AccordionSummary, { expandIcon: createElement(ExpandMoreRoundedIcon, { className: classes.filterAccordionIcon }) },
                            createElement(Typography, { className: classes.filterAccordionTitle },
                                createElement(Fragment, null, "Labels"))),
                        createElement(AccordionDetails, null,
                            createElement(FormGroup, null, labelFilterElements.length !== 0 ? (labelFilterElements) : (createElement("p", { className: classes.noFiltersAvailable }, "No labels to filter with"))))),
                    createElement(Accordion, { className: classes.filterAccordionContainer },
                        createElement(AccordionSummary, { expandIcon: createElement(ExpandMoreRoundedIcon, { className: classes.filterAccordionIcon }) },
                            createElement(Typography, { className: classes.filterAccordionTitle },
                                createElement(Fragment, null, "Publishers"))),
                        createElement(AccordionDetails, null,
                            createElement(FormGroup, null, publisherFilterElements.length !== 0 ? (publisherFilterElements) : (createElement("p", { className: classes.noFiltersAvailable }, "No publishers to filter with"))))))),
            createElement("div", { className: classes.appMarketApps },
                    ...
                    createElement("span", null,
                        filteredAppsList.length > 0
                            ...
                            : searchTerm.length === 0 &&
                                ...
                                ? allAppsList.length
                                : '0',
                        createElement(Fragment, null, " apps ")),
                    createElement(Fragment, null, "available")),
                filteredAppsList.length > 0 ? (createElement(Fragment, null,
                    createElement("div", { className: classes.appCatalogContainer },
                        createElement(AppCatalog, { appsToDisplay: filteredAppsList })),
                    createElement(Pagination, { count: 5, disabled: true, shape: "rounded", variant: "outlined" }))) : searchTerm.length === 0 &&
                    Object.values(labelFilters).includes(false) &&
                    Object.values(publisherFilters).includes(false) ? (createElement(Fragment, null,
                    createElement("div", { className: classes.appCatalogContainer },
                        createElement(AppCatalog, { appsToDisplay: allAppsList })),
                    createElement(Pagination, { count: 5, disabled: true, shape: "rounded", variant: "outlined" }))) : (createElement("p", { className: classes.noAppsToDisplay }, "No apps to display!")),
                allMarketplaceApps && (createElement("div", { className: classes.featuredAppsOuterContainer },
                    createElement("div", { className: classes.featuredAppsInnerContainer },
                        createElement("p", { className: classes.featuredAppsTitle }, "Featured apps"),
                        createElement("p", { className: classes.featuredAppsSubtitle }, "Ready to try? Subscribe to one of your featured apps to get started!"),
