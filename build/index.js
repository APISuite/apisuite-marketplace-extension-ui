...
function useSwipeable(props) {
  ...
  var transientState = React__default['default'].useRef(_extends({}, initialState, {
    type: 'hook'
  }));
  var transientProps = React__default['default'].useRef();
...
function (_React$PureComponent) {
  ...
  _proto.render = function render() {
    ...
    return React__default['default'].createElement(nodeName, _extends({}, handlers, {
      className: className,
      style: style,
      ref: ref
    }), children);
...
function getAppDetailsActionSaga(action) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                return [4 /*yield*/, effects.put(getAppDetailsActionSuccess(response))];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
