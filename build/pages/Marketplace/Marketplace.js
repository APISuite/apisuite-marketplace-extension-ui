...
const Marketplace = () => {
    ...
    return (React.createElement("main", null,
        React.createElement("header", { className: classes.appMarketHeader, style: {
                backgroundImage: `url('${custom?.images?.marketplace?.background || spaceBackground}')`,
            } },
            React.createElement("div", { className: classes.appMarketHeaderContentsContainer },
                ...
                React.createElement("div", { style: { display: 'flex' } },
                    React.createElement("img", { className: clsx({
